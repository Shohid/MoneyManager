    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LayoutInflater layoutInflaterAndroid = LayoutInflater.from(BorrowDetails.this);
                View mView = layoutInflaterAndroid.inflate(R.layout.add_sub_amount, null);
                AlertDialog.Builder alertDialogBuilderUserInput = new AlertDialog.Builder(BorrowDetails.this);
                    ...
                    public void onClick(View view) {
                        ...
                        if (!user_Input.getText().toString().isEmpty()) {
                            if (user_Input.getText().toString().length() <= 8) {
                                ...
                                String sql = "UPDATE student_borrow_pp " +"SET amount = ? " + "WHERE id = ?;";
                                ...
                                Toast.makeText(BorrowDetails.this, "  BDT" + s_other + " from " + name + " on " + date + "", Toast.LENGTH_LONG).show();
                                imm.toggleSoftInput(InputMethodManager.HIDE_IMPLICIT_ONLY, 0);
                            } else {
                                Toast.makeText(BorrowDetails.this, "Please Enter valid Amount !", Toast.LENGTH_LONG).show();
                            }
                        } else {
                            Toast.makeText(BorrowDetails.this, "EMPTY , Put amount again", Toast.LENGTH_LONG).show();
                        }
                    }
                });
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder alertDialogBuilderUserInput = new AlertDialog.Builder(BorrowDetails.this);
                alertDialogBuilderUserInput.setView(mView);
                alertDialogBuilderUserInput.setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialogBox, int id) {
                        ...
                        Toast.makeText(BorrowDetails.this, "All deleted successful !!", Toast.LENGTH_LONG).show();
...
//data[0] ৳100 data3 14 Oct 2017 data1 Rahim
                ...
                Log.d("BorrowDetails.this", " symbol[sharedPreferences.getInt(\"flag_value\", 0)] + \"\" + data[0] " + symbol[sharedPreferences.getInt("flag_value", 0)] + "" + data[0] + " data3 " + data3[0] + " data1 " + data1[0]);
            }
        }
        finally {
            if (cursor != null) {
        ...
        adapter = new CustomAdapterOne(dataModels, BorrowDetails.this);
        listView.setAdapter(adapter);


        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            public boolean onItemLongClick(final AdapterView<?> arg0, final View arg1, final int arg2, final long arg3) {
                AlertDialog.Builder builder = new AlertDialog.Builder(BorrowDetails.this);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String path = MediaStore.Images.Media.insertImage(BorrowDetails.this.getContentResolver(), b, "Title", null);
                Uri imageUri =  Uri.parse(path);
                share.putExtra(Intent.EXTRA_STREAM, imageUri);
                share.putExtra(Intent.EXTRA_TEXT,"powered by- https://play.google.com/store/apps/details?id="+BorrowDetails.this.getApplicationContext().getPackageName() );
                startActivity(Intent.createChooser(share, "Select"));
                Toast.makeText(BorrowDetails.this, "Text them to trust you.", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void addList() {
        ...
        try {
            while (cursor.moveToNext()) {
                ...
                data3[0] = cursor.getString(3);
                String rupee = getResources().getString(R.string.Rs);
                //Log.d("BorrowDetails.this", " data1 " + data1[0] + " data3 " + data3[0] + " data2 " + data2[0] + " data " + data[0]);
                Locale defaultLocale = Locale.getDefault();
                Currency currency = Currency.getInstance(defaultLocale);
                dataModels.add(new DataModel(symbol[sharedPreferences.getInt("flag_value", 0)] + "" + data[0], data2[0], data3[0]));
            }
