...
//        });
    ...
    public void setListView()
    {
        ...
        Cursor cursor=sqLiteDatabase.rawQuery("SELECT * FROM student_shopping_expanse_view_p",null);
        try {
            while(cursor.moveToNext()) {
                ...
                Log.d("star_shopping.this","finished" + data3[0] +" " + data2[0] + " "+ data1[0]);
            ...
            public boolean onItemLongClick(final AdapterView<?> arg0, final View arg1, final int arg2, final long arg3) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int ii) {
                        Cursor cursor2=sqLiteDatabase.rawQuery("SELECT * FROM student_shopping_expanse_view_p;", null);
                        ...
                        sqLiteDatabase.delete("student_shopping_expanse_view", "id=?", new String[]{Integer.toString(viewid)});
                        sqLiteDatabase.delete("student_shopping_expanse_view_p", "id=?", new String[] {Integer.toString(id)});
                    }
                });
