...
public class LendActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int i = 0;
        Cursor cur = sqLiteDatabase.rawQuery("SELECT * FROM student_lend_pp", null);
        ...
        if (len.equals("")) len = "0";
        Cursor cursor = sqLiteDatabase.rawQuery("SELECT * FROM student_lend_pp", null);
        ...
        adapter = new CustomAdapter(dataModels, LendActivity.this);
            ...
            public boolean onItemLongClick(final AdapterView<?> arg0, final View arg1, final int arg2, final long arg3) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int ii) {
                        Cursor cursor2 = sqLiteDatabase.rawQuery("SELECT * FROM student_lend_pp;", null);
                        dataModels.remove(arg2);
                        listView.setAdapter(adapter);
                        cursor2.moveToPosition(arg2);
                        final int id = cursor2.getInt(cursor2.getColumnIndex("id"));
                        sqLiteDatabase.delete("student_lend_pp", "id=?", new String[]{Integer.toString(id)});
                    }
                });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View arg1, final int arg2, long arg3) {
                ...
                Cursor cursor3 = sqLiteDatabase.rawQuery("SELECT * FROM student_lend_pp;", null);
                ...
                Intent i = new Intent(LendActivity.this, LendDetails.class);
                ...
                try {
                    while (cursor.moveToNext()) {
                        ...
                        if (query.equals(data1[0])) {
                            ...
                            ////LendActivity.this:  data1 Ajom vai data3 14 Oct 2017 data2 1 data 500
                            Intent i = new Intent(LendActivity.this, BorrowDetails.class);
                            Bundle bundle = new Bundle();
                    ...
                    public void onClick(View view) {
                        ...
                        if (!user_Input.getText().toString().isEmpty() && !user_Input_1.getText().toString().isEmpty()) {
                            if (user_Input.getText().toString().length() <= 8) {
                                ...
                                if (flag == 0) {
                                    sqLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS student_lend_pp(id INTEGER PRIMARY KEY AUTOINCREMENT,amount VARCHAR,name VARCHAR,dateyo VARCHAR,timeyo VARCHAR)");//create table
                                    sqLiteDatabase.execSQL("INSERT INTO student_lend_pp(id,amount,name,dateyo,timeyo) VALUES(null,'" + s_other + "','" + s_name + "','" + date + "','" + time + "')");//insert data fetch through edit text
                                    addList();
                                    alertDialogAndroid.dismiss();
                                    Toast.makeText(LendActivity.this, "  BDT" + s_other + " from " + s_name + " on " + date + "", Toast.LENGTH_LONG).show();
                                    imm.toggleSoftInput(InputMethodManager.HIDE_IMPLICIT_ONLY, 0);
                                } else {
                                    Toast.makeText(LendActivity.this, "Before you borrow from " + s_name + " !", Toast.LENGTH_LONG).show();
                                }

                            } else {
                                Toast.makeText(LendActivity.this, "Please Enter valid Amount !", Toast.LENGTH_LONG).show();
                            }
                        } else {
                            Toast.makeText(LendActivity.this, "EMPTY , Put amount again", Toast.LENGTH_LONG).show();
                        }
                    }
                });
