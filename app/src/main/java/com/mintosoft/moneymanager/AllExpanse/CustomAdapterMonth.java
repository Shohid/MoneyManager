 ...
 */
public class CustomAdapterMonth extends ArrayAdapter<model> implements View.OnClickListener{
    ...
    public CustomAdapterMonth(ArrayList<model> data, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int index = Integer.parseInt(dataModel.getYear());
        Log.d("index------------> : ", String.valueOf(index));
        if(index<=12)
        viewHolder.txtName.setText(str[index-1]);
