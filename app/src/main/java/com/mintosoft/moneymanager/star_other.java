...
public class star_other extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor=sqLiteDatabase.rawQuery("SELECT * FROM student_other_expanse_view_p",null);
        try {
            ...
            public boolean onItemLongClick(final AdapterView<?> arg0, final View arg1, final int arg2, final long arg3) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int ii) {
                        Cursor cursor2=sqLiteDatabase.rawQuery("SELECT * FROM student_other_expanse_view_p;", null);
                        ...
                        sqLiteDatabase.delete("student_other_expanse_view", "id=?", new String[]{Integer.toString(viewid)});
                        sqLiteDatabase.delete("student_other_expanse_view_p", "id=?", new String[] {Integer.toString(id)});
                    }
                });
